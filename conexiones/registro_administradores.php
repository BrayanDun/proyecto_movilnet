...
$sql_check_id = "SELECT p00 FROM administrador WHERE p00 = :p00";
...
$sql = "INSERT INTO administrador (p00, cedula, nombre, apellido, correo, cargo, coordinacion, contraseña) VALUES (:p00, :cedula, :nombre, :apellido, :correo, :cargo, :coordinacion, :contrasena)";
